...
int instruction_flag = 1409, att_type = 0; // ######## look for this string ########
uint32_t random_16b_insn = 51263;        // ******** look for this string ********
target_ulong rand_pc = 8;         // ^^^^^^^^^^ look for this string ^^^^^^^^^
